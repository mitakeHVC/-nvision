...
# Customer models required by customers.py endpoint
class Customer(BaseModel):
    CustomerID: str = Field(..., alias='CustomerID', description="Unique identifier for the customer, could be UUID.")
    FirstName: Optional[str] = Field(None, alias='FirstName')
    LastName: Optional[str] = Field(None, alias='LastName')
    Email: EmailStr = Field(..., alias='Email') # Assuming email is mandatory for a customer
    PhoneNumber: Optional[str] = Field(None, alias='PhoneNumber')
    Address: Optional[str] = Field(None, alias='Address')
    # CompanyName: Optional[str] = Field(None, alias='CompanyName') # If B2C, might not be relevant, or could link to Company model
    DateCreated: datetime = Field(default_factory=datetime.utcnow, alias='DateCreated')
    LastUpdated: datetime = Field(default_factory=datetime.utcnow, alias='LastUpdated')
    Status: Optional[str] = Field("active", alias='Status') # e.g., active, inactive, lead
    Segment: Optional[str] = Field(None, alias='Segment') # Customer segment
...
class CustomerCreate(BaseModel):
    ...
    PhoneNumber: Optional[str] = Field(None, alias='PhoneNumber')
    Address: Optional[str] = Field(None, alias='Address')
    Status: Optional[str] = Field("active", alias='Status')
    Segment: Optional[str] = Field(None, alias='Segment')
    # CustomerID will be generated by the system
    # DateCreated and LastUpdated will be set by the system
...
class CustomerUpdate(BaseModel):
    FirstName: Optional[str] = Field(None, alias='FirstName')
    LastName: Optional[str] = Field(None, alias='LastName')
    Email: Optional[EmailStr] = Field(None, alias='Email') # Allow email update
    PhoneNumber: Optional[str] = Field(None, alias='PhoneNumber')
    Address: Optional[str] = Field(None, alias='Address')
    Status: Optional[str] = Field(None, alias='Status')
    Segment: Optional[str] = Field(None, alias='Segment')
    # LastUpdated will be set by the system
